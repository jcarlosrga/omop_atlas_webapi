...
CREATE GLOBAL TEMPORARY TABLE temp.digits (n NUMERIC);
...
CREATE GLOBAL TEMPORARY TABLE temp.generate_dates (d_years NUMERIC,d_months NUMERIC);
...
CREATE GLOBAL TEMPORARY TABLE temp.yearly_dates (generated_date DATE);
...
CREATE GLOBAL TEMPORARY TABLE temp.monthly_dates (generated_date DATE);
...
CREATE GLOBAL TEMPORARY TABLE temp.weekly_dates (generated_date DATE);
...
CREATE GLOBAL TEMPORARY TABLE temp.quarterly_dates (generated_date DATE);
...
-- monthly dates
CREATE GLOBAL TEMPORARY TABLE temp.temp_period (period_name VARCHAR(255),period_order INT,period_type VARCHAR(50),period_start_date DATE,period_end_date DATE);
